...
#define STRING_CONFIG_H_AUTHOR "(GNOME, BIQU BX)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_SE_BX_V1_0
#endif
...
#define ENDSTOP_NOISE_Z
//#define ENDSTOP_NOISE_X
//#define ENDSTOP_NOISE_Y
